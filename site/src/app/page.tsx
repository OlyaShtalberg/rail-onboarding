  ...
  en: {
    ...
    downloads: {
      ...
      agent: {
        ...
        button: "Download AI pack (ZIP, 341 KB)",
        repoLabel: "Or browse / clone the meta-repo on GitHub →",
        repoHref: "https://github.com/rezolved/rail-metarepo",
        files: [
          ...
          "rezolve-design-system.md — colors, fonts, brand voice (rezolve.com extract)",
  ...
  ru: {
    ...
    downloads: {
      ...
      agent: {
        ...
        button: "Скачать AI pack (ZIP, 341 KB)",
        ...
        files: [
          ...
          "team-skills.md — teams-outlook-setup",
          "rezolve-design-system.md — цвета, шрифты, brand voice (extract с rezolve.com)",
